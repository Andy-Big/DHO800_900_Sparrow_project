...
public class PopupviewMathBindingImpl extends PopupviewMathBinding {
    ...
    public PopupviewMathBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 3, sIncludes, sViewsWithIds));
    }

    private PopupviewMathBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
