...
public abstract class PopupviewCalibrationBinding extends ViewDataBinding {
    ...
    @Bindable
    protected CalibrationParam mCalibrationParam;
    @Bindable
    ...
    public abstract void setCalibrationParam(CalibrationParam calibrationParam);
    ...
    public static PopupviewCalibrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        return inflate(layoutInflater, viewGroup, z, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static PopupviewCalibrationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z, Object obj) {
        return (PopupviewCalibrationBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.popupview_calibration, viewGroup, z, obj);
    }

    public static PopupviewCalibrationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static PopupviewCalibrationBinding inflate(LayoutInflater layoutInflater, Object obj) {
        return (PopupviewCalibrationBinding) ViewDataBinding.inflateInternal(layoutInflater, R.layout.popupview_calibration, null, false, obj);
    }

    public static PopupviewCalibrationBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static PopupviewCalibrationBinding bind(View view, Object obj) {
        return (PopupviewCalibrationBinding) bind(obj, view, R.layout.popupview_calibration);
    }
}
