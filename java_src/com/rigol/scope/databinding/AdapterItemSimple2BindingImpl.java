...
public class AdapterItemSimple2BindingImpl extends AdapterItemSimple2Binding {
    ...
    public AdapterItemSimple2BindingImpl(DataBindingComponent dataBindingComponent, View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 3, sIncludes, sViewsWithIds));
    }

    private AdapterItemSimple2BindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
