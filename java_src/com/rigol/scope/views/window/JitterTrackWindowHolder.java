...
public final class JitterTrackWindowHolder extends WindowHolder {
    ...
    public JitterTrackWindowHolder(Context context, WindowParam windowParam) {
        super(windowParam);
        ...
        JitterTrackGridRulerView jitterTrackGridRulerView = new JitterTrackGridRulerView(this.context, null, 0, 6, null);
        jitterTrackGridRulerView.setId(R.id.window_grid_line);
        Unit unit = Unit.INSTANCE;
        this.gridRulerView = jitterTrackGridRulerView;
        ...
        inflate.windowClose.setOnClickListener(new View.OnClickListener() { // from class: com.rigol.scope.views.window.JitterTrackWindowHolder$$special$$inlined$apply$lambda$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                WindowHolderManager.getInstance().remove(JitterTrackWindowHolder.this);
            }
        });
        inflate.windowSetting.setOnClickListener(new View.OnClickListener() { // from class: com.rigol.scope.views.window.JitterTrackWindowHolder$binding$1$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (jitterViewModel != null && (liveData = jitterViewModel.getLiveData()) != null) {
            ...
            if (topActivity != null) {
                liveData.observe((LifecycleOwner) topActivity, new Observer<JitterParam>() { // from class: com.rigol.scope.views.window.JitterTrackWindowHolder.1
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(JitterParam jitterParam) {
                        JitterTrackWindowHolder.this.jitterParam = jitterParam;
                        JitterTrackWindowHolder.this.updateTitle();
                    }
                });
            } else {
        ...
        if (syncDataViewModel != null && (mutableLiveData2 = syncDataViewModel.get(52, MessageID.MSG_JITTER_SOURCE)) != null) {
            ...
            mutableLiveData2.observe((LifecycleOwner) topActivity2, new Observer<Object>() { // from class: com.rigol.scope.views.window.JitterTrackWindowHolder.2
                @Override // androidx.lifecycle.Observer
        ...
        mutableLiveData.observe((LifecycleOwner) topActivity3, new Observer<Boolean>() { // from class: com.rigol.scope.views.window.JitterTrackWindowHolder.3
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Boolean bool) {
                boolean UI_QueryBool = API.getInstance().UI_QueryBool(52, MessageID.MSG_JITTER_STATUS);
                TextView textView = JitterTrackWindowHolder.this.getBinding().status;
    ...
    public void updateTitle() {
        ...
        if (jitterParam != null) {
            ...
            MappingObject mappingObject = ViewUtil.getMappingObject(R.array.window_type_list, ServiceEnum.WindowType.WIN_JITTER_TRACK.value1);
            Intrinsics.checkNotNullExpressionValue(mappingObject, "ViewUtil.getMappingObjec…RACK.value1\n            )");
