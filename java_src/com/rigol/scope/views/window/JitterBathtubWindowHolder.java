...
public final class JitterBathtubWindowHolder extends WindowHolder {
    ...
    public JitterBathtubWindowHolder(Context context, WindowParam windowParam) {
        super(windowParam);
        ...
        JitterBathtubCurveGridRulerView jitterBathtubCurveGridRulerView = new JitterBathtubCurveGridRulerView(this.context, null, 0, 6, null);
        jitterBathtubCurveGridRulerView.setId(R.id.window_grid_line);
        Unit unit = Unit.INSTANCE;
        this.gridRulerView = jitterBathtubCurveGridRulerView;
        ...
        inflate.windowClose.setOnClickListener(new View.OnClickListener() { // from class: com.rigol.scope.views.window.JitterBathtubWindowHolder$$special$$inlined$apply$lambda$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                WindowHolderManager.getInstance().remove(JitterBathtubWindowHolder.this);
            }
        });
        inflate.windowSetting.setOnClickListener(new View.OnClickListener() { // from class: com.rigol.scope.views.window.JitterBathtubWindowHolder$binding$1$2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (jitterViewModel != null && (liveData = jitterViewModel.getLiveData()) != null) {
            ...
            if (topActivity != null) {
                liveData.observe((LifecycleOwner) topActivity, new Observer<JitterParam>() { // from class: com.rigol.scope.views.window.JitterBathtubWindowHolder.1
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(JitterParam jitterParam) {
                        JitterBathtubWindowHolder.this.jitterParam = jitterParam;
                        JitterBathtubWindowHolder.this.updateTitle();
                    }
                });
            } else {
        ...
        if (syncDataViewModel != null && (mutableLiveData2 = syncDataViewModel.get(52, MessageID.MSG_JITTER_SOURCE)) != null) {
            ...
            mutableLiveData2.observe((LifecycleOwner) topActivity2, new Observer<Object>() { // from class: com.rigol.scope.views.window.JitterBathtubWindowHolder.2
                @Override // androidx.lifecycle.Observer
        ...
        mutableLiveData.observe((LifecycleOwner) topActivity3, new Observer<Boolean>() { // from class: com.rigol.scope.views.window.JitterBathtubWindowHolder.3
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Boolean bool) {
                boolean UI_QueryBool = API.getInstance().UI_QueryBool(52, MessageID.MSG_JITTER_STATUS);
                TextView textView = JitterBathtubWindowHolder.this.getBinding().status;
    ...
    public void updateTitle() {
        ...
        if (jitterParam != null) {
            ...
            MappingObject mappingObject = ViewUtil.getMappingObject(R.array.window_type_list, ServiceEnum.WindowType.WIN_JITTER_BATHTUB_CURVE.value1);
            Intrinsics.checkNotNullExpressionValue(mappingObject, "ViewUtil.getMappingObjec…URVE.value1\n            )");
