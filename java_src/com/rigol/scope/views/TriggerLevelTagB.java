...
public final class TriggerLevelTagB extends TagView {
    ...
    public TriggerLevelTagB(Context context, AttributeSet attributeSet) {
        ...
        setTagWidth(35);
        setTagHeight(20);
        setText(ContextUtil.getString(R.string.trigger_tag_b));
        ...
        if (syncDataViewModel != null && (mutableLiveData2 = syncDataViewModel.get(41, MessageID.MSG_TRIGGER_TYPE)) != null) {
            ...
            mutableLiveData2.observe((LifecycleOwner) context2, new Observer<Object>() { // from class: com.rigol.scope.views.TriggerLevelTagB.1
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    TriggerLevelTagB.this.setPosition(true);
                }
            });
        }
        if (syncDataViewModel == null || (mutableLiveData = syncDataViewModel.get(41, MessageID.MSG_TRIGGER_LEVEL_B)) == null) {
            return;
        }
        ...
        mutableLiveData.observe((LifecycleOwner) context3, new Observer<Object>() { // from class: com.rigol.scope.views.TriggerLevelTagB.2
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                TriggerLevelTagB.this.setPosition(true);
            }
    ...
    public final void setPosition(boolean z) {
        ...
        if (value.getTriggerMode() == ServiceEnum.TriggerMode.Trigger_Slope || value.getTriggerMode() == ServiceEnum.TriggerMode.Trigger_Runt || value.getTriggerMode() == ServiceEnum.TriggerMode.Trigger_Over || value.getTriggerMode() == ServiceEnum.TriggerMode.Trigger_1553) {
            ...
            if (value2 == null || !value2.isEmpty()) {
                float valuePercent = ViewUtil.getValuePercent(ViewUtil.getVerticalItem(value2, value.getChan()), value.getLevelB());
