...
public final class MeasureMidThresLine extends LineView {
    ...
    public MeasureMidThresLine(Context context, AttributeSet attributeSet) {
        ...
        if (verticalViewModel != null && (liveData3 = verticalViewModel.getLiveData()) != null) {
            ...
            if (topActivity != null) {
                liveData3.observe((LifecycleOwner) topActivity, new Observer<ArrayList<VerticalParam>>() { // from class: com.rigol.scope.views.baseview.MeasureMidThresLine.1
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(ArrayList<VerticalParam> arrayList) {
                        MeasureMidThresLine.this.setVerticalParams(arrayList);
                    }
                });
            } else {
        ...
        if (sharedViewModel != null && (liveData2 = sharedViewModel.getLiveData()) != null) {
            ...
            if (topActivity2 != null) {
                liveData2.observe((LifecycleOwner) topActivity2, new Observer<SharedParam>() { // from class: com.rigol.scope.views.baseview.MeasureMidThresLine.2
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(SharedParam sharedParam) {
                        MeasureMidThresLine measureMidThresLine = MeasureMidThresLine.this;
                        Intrinsics.checkNotNullExpressionValue(sharedParam, "sharedParam");
                        measureMidThresLine.sharedParam = sharedParam;
                    }
                });
            } else {
                throw new NullPointerException("null cannot be cast to non-null type androidx.lifecycle.LifecycleOwner");
        ...
        if (measureSettingViewModel != null && (liveData = measureSettingViewModel.getLiveData()) != null) {
            ...
            if (topActivity3 != null) {
                liveData.observe((LifecycleOwner) topActivity3, new Observer<MeasureSettingParam>() { // from class: com.rigol.scope.views.baseview.MeasureMidThresLine.3
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(MeasureSettingParam measureSettingParam) {
                        ...
                        measureMidThresLine.measureSettingParam = measureSettingParam;
                        OrientationView.Companion.setStrThresholdMiddle(String.valueOf(MeasureMidThresLine.access$getMeasureSettingParam$p(MeasureMidThresLine.this).getThresholdMiddle()));
                    }
                });
            } else {
                throw new NullPointerException("null cannot be cast to non-null type androidx.lifecycle.LifecycleOwner");
    ...
    public static final /* synthetic */ MeasureSettingParam access$getMeasureSettingParam$p(MeasureMidThresLine measureMidThresLine) {
        MeasureSettingParam measureSettingParam = measureMidThresLine.measureSettingParam;
    ...
    public static final /* synthetic */ SharedParam access$getSharedParam$p(MeasureMidThresLine measureMidThresLine) {
        SharedParam sharedParam = measureMidThresLine.sharedParam;
        if (sharedParam == null) {
    ...
    public final void setPosition(int i, long j) {
        ...
        if (measureSettingParam.getThresholdType() == ServiceEnum.ThreType.TH_TYPE_ABS) {
            ...
            String convert = newBuilder.convert(measureSettingParam2.getThresholdMiddle(), ServiceEnum.Unit.Unit_V);
            Intrinsics.checkNotNullExpressionValue(convert, "UnitFormat.newBuilder( U…ServiceEnum.Unit.Unit_V )");
            companion.setStrThresholdMiddle(convert);
        ...
        if (measureSettingParam4.getThresholdType() == ServiceEnum.ThreType.TH_TYPE_PER) {
            ...
            sb.append(String.valueOf(measureSettingParam5.getThresholdMiddle()));
            sb.append("%");
            companion2.setStrThresholdMiddle(sb.toString());
