...
public class StoreHousePath {
    ...
    static {
        ...
        sPointList.append(32, new float[0]);
        sPointList.append(45, new float[]{0.0f, 36.0f, 47.0f, 36.0f});
        sPointList.append(46, new float[]{24.0f, 60.0f, 24.0f, 72.0f});
    }

    public static List<float[]> getPath(String str, float f, int i) {
