...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1<T> implements FlowCollector<T> {
    ...
    */
    public Object emit(Object obj, Continuation continuation) {
        ...
        int i;
        FlowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1<T> flowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1;
        Ref.IntRef intRef;
        if (continuation instanceof AnonymousClass1) {
            ...
            if ((anonymousClass1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    flowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1 = (FlowKt__LimitKt$take$$inlined$unsafeFlow$1$lambda$1) anonymousClass1.L$0;
                    ResultKt.throwOnFailure(obj2);
                }
