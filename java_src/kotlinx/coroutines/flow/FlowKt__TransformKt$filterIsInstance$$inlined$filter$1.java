...
public final class FlowKt__TransformKt$filterIsInstance$$inlined$filter$1 implements Flow<Object> {
    ...
    public static final class AnonymousClass2 implements FlowCollector<Object> {
        ...
        public Object emit(Object obj, Continuation continuation) {
            ...
            return Boxing.boxBoolean(obj instanceof Object).booleanValue() ? flowCollector.emit(obj, continuation) : Unit.INSTANCE;
        }
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        ...
        return flow.collect(new AnonymousClass2(flowCollector, this), continuation);
    }
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        flow.collect(new AnonymousClass2(flowCollector, this), continuation);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
