...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1346SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* renamed from: SupervisorJob$default  reason: collision with other method in class */
    public static /* synthetic */ Job m1347SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1346SupervisorJob(job);
    }
