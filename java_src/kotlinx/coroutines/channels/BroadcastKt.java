...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> broadcast, int i, CoroutineStart start) {
        ...
        return broadcast(GlobalScope.INSTANCE, Dispatchers.getUnconfined(), i, start, ChannelsKt.consumes(broadcast), new BroadcastKt$broadcast$1(broadcast, null));
    }
