...
public interface SelectBuilder<R> {
    ...
    public static final class DefaultImpls {
        ...
        public static <R, P, Q> void invoke(SelectBuilder<? super R> selectBuilder, SelectClause2<? super P, ? extends Q> invoke, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> block) {
            Intrinsics.checkParameterIsNotNull(invoke, "$this$invoke");
            Intrinsics.checkParameterIsNotNull(block, "block");
            selectBuilder.invoke(invoke, null, block);
        }
    }
}
