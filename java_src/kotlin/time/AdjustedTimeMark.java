...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final double m1281getAdjustmentUwyO8pc() {
    ...
    public double mo1279elapsedNowUwyO8pc() {
        return Duration.m1309minusLRDsOJo(this.mark.mo1279elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1280plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1310plusLRDsOJo(this.adjustment, d), null);
    }
}
