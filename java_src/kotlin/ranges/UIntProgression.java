...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1195getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }

    /* renamed from: getFirst-pVg5ArA  reason: not valid java name */
    public final int m1209getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1210getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m151toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m151toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1211fromClosedRangeNkh28Cs(int i, int i2, int i3) {
