...
public final class UStringsKt {
    ...
    public static final String m1276toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1278toStringolVBNx4(short s, int i) {
    ...
    public static final String m1277toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1275toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m87unboximpl();
        }
    ...
    public static final short toUShort(String toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m323unboximpl();
        }
    ...
    public static final int toUInt(String toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m157unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m157unboximpl = uIntOrNull.m157unboximpl();
            if (UnsignedKt.uintCompare(m157unboximpl, UInt.m114constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m40boximpl(UByte.m46constructorimpl((byte) m157unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        if (uIntOrNull != null) {
            int m157unboximpl = uIntOrNull.m157unboximpl();
            if (UnsignedKt.uintCompare(m157unboximpl, UInt.m114constructorimpl(65535)) > 0) {
                return null;
            }
            return UShort.m276boximpl(UShort.m282constructorimpl((short) m157unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int m114constructorimpl = UInt.m114constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m343uintDivideJ1ME1BU(-1, m114constructorimpl);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int m114constructorimpl2 = UInt.m114constructorimpl(i2 * m114constructorimpl);
            int m114constructorimpl3 = UInt.m114constructorimpl(UInt.m114constructorimpl(digitOf) + m114constructorimpl2);
            if (UnsignedKt.uintCompare(m114constructorimpl3, m114constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = m114constructorimpl3;
        }
        return UInt.m108boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long m184constructorimpl = ULong.m184constructorimpl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m345ulongDivideeb3DHEI(j, m184constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long m184constructorimpl2 = ULong.m184constructorimpl(j2 * m184constructorimpl);
            long m184constructorimpl3 = ULong.m184constructorimpl(ULong.m184constructorimpl(UInt.m114constructorimpl(digitOf) & UIDFolder.MAXUID) + m184constructorimpl2);
            if (UnsignedKt.ulongCompare(m184constructorimpl3, m184constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = m184constructorimpl3;
            j = -1;
        }
        return ULong.m178boximpl(j2);
    }
}
