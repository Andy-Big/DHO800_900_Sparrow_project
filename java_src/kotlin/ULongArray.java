...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static final /* synthetic */ ULongArray m228boximpl(long[] v) {
        Intrinsics.checkNotNullParameter(v, "v");
        return new ULongArray(v);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long[] m230constructorimpl(long[] storage) {
    ...
    public static boolean m233equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual(jArr, ((ULongArray) obj).m244unboximpl());
    }
    ...
    public static final long m235getsVKNKU(long[] jArr, int i) {
        return ULong.m184constructorimpl(jArr[i]);
    }
    ...
    public static ULongIterator m239iteratorimpl(long[] jArr) {
    ...
    public static final class Iterator extends ULongIterator {
        ...
        public long mo245nextULongsVKNKU() {
            int i = this.index;
    ...
    public static boolean m232containsAllimpl(long[] jArr, Collection<ULong> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<ULong> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof ULong) && ArraysKt.contains(jArr, ((ULong) obj).m227unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
