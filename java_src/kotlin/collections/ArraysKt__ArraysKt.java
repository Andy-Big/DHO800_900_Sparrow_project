        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m538contentEqualskV0jMPg(((UByteArray) t).m104unboximpl(), ((UByteArray) t2).m104unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m535contentEqualsFGO6Aew(((UShortArray) t).m340unboximpl(), ((UShortArray) t2).m340unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m536contentEqualsKJPZfPQ(((UIntArray) t).m174unboximpl(), ((UIntArray) t2).m174unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m540contentEqualslec5QzE(((ULongArray) t).m244unboximpl(), ((ULongArray) t2).m244unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m552contentToString2csIQuQ(uByteArray != null ? uByteArray.m104unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m556contentToStringd6D3K8(uShortArray != null ? uShortArray.m340unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m555contentToStringXUkPCBk(uIntArray != null ? uIntArray.m174unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m558contentToStringuLth9ew(uLongArray != null ? uLongArray.m244unboximpl() : null));
            } else {
