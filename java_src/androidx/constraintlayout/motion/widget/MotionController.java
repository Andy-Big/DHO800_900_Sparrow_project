    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (this.mStaggerScale != f2) {
                ...
                if (f4 > f5 && f4 < 1.0d) {
                    f4 = Math.min((f4 - f5) * this.mStaggerScale, f2);
                }
            }
            float f6 = f4;
            double d = f6;
            ...
            if (easing != null) {
                ...
                d = (((float) easing.get((f6 - f8) / f)) * (f7 - f8)) + f8;
            }
            double d2 = d;
    ...
    void buildBounds(float[] fArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (this.mStaggerScale != 1.0f) {
                ...
                float f5 = this.mStaggerOffset;
                if (f3 > f5 && f3 < 1.0d) {
                    f3 = Math.min((f3 - f5) * this.mStaggerScale, 1.0f);
                }
            }
            double d = f3;
            Easing easing = this.mStartMotionPath.mKeyFrameEasing;
            ...
            while (i17 < size) {
                if (motionPathsArr[i17].hasCustomData(str8)) {
                    if (dArr3 == null) {
                        ...
                        iArr3[i3] = size;
                        dArr3 = (double[][]) Array.newInstance(double.class, iArr3);
        ...
        if (hashMap2 != null) {
            ...
            for (TimeCycleSplineSet timeCycleSplineSet : hashMap2.values()) {
                if (timeCycleSplineSet instanceof TimeCycleSplineSet.PathRotate) {
                    ...
                    z2 |= timeCycleSplineSet.setProperty(view, f5, j, keyCache);
                }
            }
            z = z2;
        } else {
            ...
            if (hashMap3 != null) {
                for (SplineSet splineSet2 : hashMap3.values()) {
                    if (splineSet2 instanceof SplineSet.PathRotate) {
                        ...
                        if (dArr2.length > 1) {
                            ((SplineSet.PathRotate) splineSet2).setPathRotate(view, f5, dArr2[0], dArr2[1]);
                        }
                    }
                }
            }
        ...
        if (hashMap4 != null) {
            for (KeyCycleOscillator keyCycleOscillator : hashMap4.values()) {
                if (keyCycleOscillator instanceof KeyCycleOscillator.PathRotateSet) {
                    ...
                    ((KeyCycleOscillator.PathRotateSet) keyCycleOscillator).setPathRotate(view, f5, dArr4[0], dArr4[i]);
                } else {
                    keyCycleOscillator.setProperty(view, f5);
                }
            }
        }
        return z;
