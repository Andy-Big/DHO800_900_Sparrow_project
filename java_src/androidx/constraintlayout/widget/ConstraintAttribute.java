...
public class ConstraintAttribute {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[AttributeType.REFERENCE_TYPE.ordinal()] = 8;
        ...
        try {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[this.mType.ordinal()]) {
                ...
                case 8:
                    ...
                    if (AttributeType.REFERENCE_TYPE == this.mType) {
                        Log.v(TAG, " call ing " + str + "  " + Debug.getName(view.getContext(), this.mIntegerValue));
                        return;
                    }
                    return;
                case 4:
