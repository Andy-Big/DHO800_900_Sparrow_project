    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public boolean isViewPartiallyVisible(View view, boolean z, boolean z2) {
            boolean z3 = this.mHorizontalBoundCheck.isViewWithinBoundFlags(view, MessageID.INF_ZONE_SMALL) && this.mVerticalBoundCheck.isViewWithinBoundFlags(view, MessageID.INF_ZONE_SMALL);
            return z ? z3 : !z3;
        }
